"""
Django settings for _formis project.
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'testuser.testeur@gmail.com'
EMAIL_HOST_PASSWORD = 'ghld yesn jlez roop'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
...
SITE_NAME = 'Plateforme d\'Inscription'
SITE_URL = 'http://localhost:8000'  # À changer en production

# Configuration du logging pour débugger les emails
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/enrollment.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
# Configuration pour les tests d'email (optionnel)
if DEBUG:
    # En mode développement, aussi afficher les emails dans la console
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    # Ou pour tester avec un fichier
