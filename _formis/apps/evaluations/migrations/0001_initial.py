    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matiere', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='evaluations', to='courses.matiere', verbose_name='Matière du module')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matiere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='courses.matiere', verbose_name='Matière du module')),
            ],
            options={
                'verbose_name': 'Note',
